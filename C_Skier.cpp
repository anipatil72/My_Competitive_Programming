...
void solve()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        if (s[i] == 'N')
        {
            if (m.count({left, up, left, up + 1}) == 0 && m.count({left, up + 1, left, up}) == 0)
            {
                m.insert({left, up, left, up + 1});
                ans += 5;
            }
            else
            {
        ...
        {
            if (m.count({left, up, left + 1, up}) == 0 && m.count({left + 1, up, left, up}) == 0)
            {
                m.insert({left, up, left + 1, up});
                ans += 5;
            }
            else
            {
