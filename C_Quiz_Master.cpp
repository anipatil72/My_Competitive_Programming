...
int minimize_difference(vector<int>& a, int n, int m)
{
    // int prof[m + 1] = {0};
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        if (team.size() == m)
        {
            int max_elem = *max_element(team.begin(), team.end());
            int min_elem = *min_element(team.begin(), team.end());
...
void solve()
{
    ...
    cout<<minimize_difference(a,n,m)<<endl;
