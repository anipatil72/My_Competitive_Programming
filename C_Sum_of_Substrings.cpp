...
void solve()
{
    ...
    else
    {
        ...
        if (left <= k)
        {
            ...
            fir.insert(fir.begin(), '1');

            ans = min(ans, deduce(fir));
        ...
        if ((n - 1 - right) <= k)
        {
            ...
            sec.insert(sec.end(), '1');

            ans = min(ans, deduce(sec));
        ...
        if ((left + (n - 1 - right)) <= k)
        {
            ...
            thir.insert(thir.begin(), '1');

            // ans = min(ans, deduce(thir));

            thir.erase(right, 1);

            thir.insert(thir.end(), '1');
