...
void solve()
{
    ...
    else
    {
        for (int i = 0; i < pos.size() - 1; i++)
        {
            ...
            ans += give(pos[i + 1] - pos[i] - 1, k);
        }

        ans += giveSpecial(pos[0], k);

        // cout << "I am here to : " << give(pos[0], k) << endl;

        ans += giveSpecial(n - 1 - pos.back(), k);

        // cout << "I am also here ! " << give(n - 1 - pos.back(), k) << endl;
    }
