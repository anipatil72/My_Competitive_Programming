...
void solve()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        for (int j = i; j < n; j++)
        {
            ...
            else
            {
                ...
                int m = i > 0 ? pref[i - 1] : 0;

                int bad = pref[j] - m;

                // cout << "This is bad : " << bad << endl;
    ...
    // cout << "Teh ans is : " << endl;

    cout << ans << endl;

    // Time limit exceeded on test 21

    // We have to deal with the edge cases ; n= 1, 2, etc
}
...
int main()
{
    ...
    // string s = "Patil_Aniruddha_Ramesh";
