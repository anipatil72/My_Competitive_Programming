...
bool myComp(pair<vector<int>, int> &a, pair<vector<int>, int> &b)
{
    if (a.first == b.first)
    {
...
string rankTeams(vector<string> &votes)
{
    ...
    vector<vector<int>> pos(26, vector<int>(len, 0));
    ...
    vector<pair<vector<int>, int>> tem;

    for (int i = 0; i < 26; i++)
    {
        tem.push_back({pos[i], i});
    }
...
int main()
{
    ...
    vector<string> test = {"ZMNAGUEDSJYLBOPHRQICWFXTVK"};
